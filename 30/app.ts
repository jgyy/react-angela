...
const aboutContent = "Hac habitasse platea dictumst vestibulum rhoncus est pellentesque."
  ...
  + " Egestas sed sed risus pretium quam vulputate dignissim suspendisse. Mauris in aliquam sem fringilla."
  ...
  + " Enim ut tellus elementum sagittis vitae. Mauris ultrices eros in cursus turpis massa tincidunt dui.";
const contactContent = "Scelerisque eleifend donec pretium vulputate sapien. Rhoncus urna neque viverra justo nec ultrices."
  + " Arcu dui vivamus arcu felis bibendum. Consectetur adipiscing elit duis tristique."
  + " Risus viverra adipiscing at in tellus integer feugiat. Sapien nec sagittis aliquam malesuada bibendum arcu vitae."
  + " Consequat interdum varius sit amet mattis. Iaculis nunc sed augue lacus."
  + " Interdum posuere lorem ipsum dolor sit amet consectetur adipiscing elit. Pulvinar elementum integer enim neque."
  + " Ultrices gravida dictum fusce ut placerat orci nulla. Mauris in aliquam sem fringilla ut morbi tincidunt."
...
app.get("/compose", function (req, res) {
  res.render(path.join(__dirname, 'views', 'compose'));
});
...
app.get("/posts/:postId", function (req, res) {
  ...
  Post.findOne({ _id: requestedPostId }).then(function (post: any) {
...
app.get("/about", function (req, res) {
  res.render(path.join(__dirname, 'views', 'about'), { aboutContent: aboutContent });
});

app.get("/contact", function (req, res) {
  res.render(path.join(__dirname, 'views', 'contact'), { contactContent: contactContent });
});
